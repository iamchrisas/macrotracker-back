...
module.exports = (app) => {
  ...
  app.use(
    cors({
      origin: [FRONTEND_URL], // Ensure CORS is configured to accept requests from your frontend
      credentials: true, // If your frontend needs to send cookies or rely on session-based authentication, enable this
    })
  );
